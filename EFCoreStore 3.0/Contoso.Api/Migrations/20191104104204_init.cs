    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleOrderAddresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleOrderAddresses_SaleOrder_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleOrderBillingAddress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleOrderBillingAddress_SaleOrderAddresses_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "SaleOrderAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleOrderShippingAddress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleOrderShippingAddress_SaleOrderAddresses_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "SaleOrderAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleOrderAddresses_OwnerId",
                table: "SaleOrderAddresses",
                column: "OwnerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SaleOrderBillingAddress_OwnerId",
                table: "SaleOrderBillingAddress",
                column: "OwnerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleOrderShippingAddress_OwnerId",
                table: "SaleOrderShippingAddress",
                column: "OwnerId",
                unique: true);
